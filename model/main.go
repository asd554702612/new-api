...
func migrateDBFast() error {
	...
	migrations := []struct {
		...
		{&AffiliateIdentity{}, "AffiliateIdentity"},
		{&AffiliateSignupFingerprint{}, "AffiliateSignupFingerprint"},
		{&Ability{}, "Ability"},
		{&Log{}, "Log"},
		...
		{&Checkin{}, "Checkin"},
		{&WeeklyQuotaClaim{}, "WeeklyQuotaClaim"},
		{&SubscriptionOrder{}, "SubscriptionOrder"},
		{&UserSubscription{}, "UserSubscription"},
		{&SubscriptionPreConsumeRecord{}, "SubscriptionPreConsumeRecord"},
		{&PaymentOrderRefund{}, "PaymentOrderRefund"},
		{&PaymentOrderAuditLog{}, "PaymentOrderAuditLog"},
		{&PaymentActivityChance{}, "PaymentActivityChance"},
		{&PaymentActivityConfig{}, "PaymentActivityConfig"},
		{&LuckyWheelSession{}, "LuckyWheelSession"},
		{&LuckyWheelDrawRecord{}, "LuckyWheelDrawRecord"},
		{&LuckyWheelGoldenWindowClaim{}, "LuckyWheelGoldenWindowClaim"},
		{&LuckyWheelInviteBonusEvent{}, "LuckyWheelInviteBonusEvent"},
		{&RechargeActivityChance{}, "RechargeActivityChance"},
		{&RechargeActivityDrawRecord{}, "RechargeActivityDrawRecord"},
...
` + "`purchase_once_per_active_subscription`" + ` numeric DEFAULT 0,
` + "`sale_starts_at`" + ` bigint DEFAULT 0,
` + "`sale_ends_at`" + ` bigint DEFAULT 0,
` + "`daily_sale_starts_at`" + ` varchar(5) DEFAULT '',
` + "`daily_sale_ends_at`" + ` varchar(5) DEFAULT '',
` + "`weekly_sale_days`" + ` text DEFAULT '[]',
...
PRIMARY KEY (` + "`id`" + `)
	...
	required := []sqliteColumnDef{
		...
		{Name: "daily_purchase_limit", DDL: "`daily_purchase_limit` integer DEFAULT 0"},
		{Name: "purchase_once_per_active_subscription", DDL: "`purchase_once_per_active_subscription` numeric DEFAULT 0"},
		{Name: "sale_starts_at", DDL: "`sale_starts_at` bigint DEFAULT 0"},
		{Name: "sale_ends_at", DDL: "`sale_ends_at` bigint DEFAULT 0"},
		{Name: "daily_sale_starts_at", DDL: "`daily_sale_starts_at` varchar(5) DEFAULT ''"},
		{Name: "daily_sale_ends_at", DDL: "`daily_sale_ends_at` varchar(5) DEFAULT ''"},
		{Name: "weekly_sale_days", DDL: "`weekly_sale_days` text DEFAULT '[]'"},
