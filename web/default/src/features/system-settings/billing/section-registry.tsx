    ...
    build: (settings: BillingSettings) => (
      <PaymentSettingsSection
        defaultValues={{
          ...
          WechatPayJSAPIEnabled: settings.WechatPayJSAPIEnabled ?? false,
          WechatPayH5Enabled: settings.WechatPayH5Enabled ?? true,
          WechatPayNativeEnabled: settings.WechatPayNativeEnabled ?? true,
          ...
          AlipayPageEnabled: settings.AlipayPageEnabled ?? true,
          AlipayWapEnabled: settings.AlipayWapEnabled ?? true,
          AlipayFaceEnabled: settings.AlipayFaceEnabled ?? true,
        }}
        waffoDefaultValues={{
