...
export function DataTableRowActions({ row }: DataTableRowActionsProps) {
  ...
  const handlePlanSubscriptions = () => {
    setCurrentRow(row.original)
    setOpen('plan-subscriptions')
  }
        ...
        <TooltipTrigger
          render={
            <Button
              variant='ghost'
              size='icon-sm'
              onClick={handlePlanSubscriptions}
              aria-label={t('Purchased Users')}
            />
          }
        >
          <Users />
        </TooltipTrigger>
        <TooltipContent>{t('Purchased Users')}</TooltipContent>
      </Tooltip>
